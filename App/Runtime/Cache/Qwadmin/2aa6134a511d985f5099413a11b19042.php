                ...
                <ul class="nav ace-nav">
                    ...
                    <li class="light-blue">
                        <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                            <img class="nav-user-photo" src="<?php if( $user["head"] == '' ): ?>/Public/qwadmin/images/avatar.png"
                            "<?php else: ?>
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <div class="row">
                            <div id="weather" class="accordion-style1 panel-group col-sm-4">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-collapse collapse in" id="weather-data">
                                        <div id="weather-data-detail" class="panel-body" >
                                            <ul>
                                            </ul>
                                        </div>
                                    </div>
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#weather-data-detail").attr('style','background: #299ae6;');
                $("#weather-data-detail ul").html("<a id='weather-icon'></a><a style='font-size:1.5em;color:white;' id='city'>" + data.Weather.city + "</a>&nbsp;&nbsp;&nbsp;&nbsp;" + "<a style='font-size:1em;color:white;'>" + 
                data.Weather.status1 + "</a>");
                if(data.Weather.figure1 == 'qing'){
                    $("#weather-data-detail ul #weather-icon").html("<img src='http://mjs.sinaimg.cn/wap/dpool/weather/weather_icon/256_256/"+ "qing" + "_bai_0.png' style='width:128px;'/> ");
                }
                // $.each(data.Weather, function (i, Weather) {
                //     $("##weather-data-detail ul").append("<li>" + Weather.city + "</li>");
                // });
            },
            error: function () {
                $("#weather-data-detail ul").html("服务器不可用，请稍后再试！");
            },
            dataType: 'json'
        });
